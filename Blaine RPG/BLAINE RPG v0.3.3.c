...
#include <conio.h>
#include <windows.h> //tem q incluir essa biblioteca para o som beep
/*
m1=Lestrigones;
m2=Godizika;
m3=Ness;
...
int ataque, vida, classe,decisao1,decisao2,restart,i;
int iDecisaoMenu, titulo;

m2[15] = 'n';
system("MODE con cols=90 lines=46");// Comando para definir tamanho da tela
system("title Tela em BLAINE RPG");//Comando para colocar o titulo no exe
...
printf("///////////     ////////   /               /  //   //        ////  ////////// \n" );
printf("______________________________________________________________________________\n\n\t\t" );
Beep(1400,1500); //faz um som com uma frequenca de 1400 Hertz e com tempo d 1500 milisegundos d duraçao.
system("cls");
...
else if (iDecisaoMenu == 4) Beep(1400,2000); exit(1);
//__________________________________________________MENU__________________________________________________
